context 'Apivore tests running against a mock API' do
  describe 'the test checks unimplemented path' do
    it 'should show an alert that the specific path is unimplemented' do
      ...
      expect(stdout).to match(%r{Path \/not_implemented.json did not respond with expected status code. Expected 200 got 404})
    end
  end
  ...
  describe 'a response is missing an optional property' do
